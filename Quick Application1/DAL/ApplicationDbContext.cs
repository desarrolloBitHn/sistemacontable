...
namespace DAL
{
    public class ApplicationDbContext : IdentityDbContext<ApplicationUser, ApplicationRole, string>
    {
        ...
        public DbSet<nivelcuenta> nivelcuenta { get; set; }

        public DbSet<naturalezacuenta> naturalezacuenta { get; set; }

        public DbSet<categoriacuenta> categoriacuenta { get; set; }

        public DbSet<moneda> moneda { get; set; }

        public DbSet<cambiodolarhistorial> cambiodolarhistorial { get; set; }
